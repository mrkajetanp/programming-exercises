...
static void test_trinary_to_hex(void)
{
...
static void test_hex_to_trinary(void)
{
   int8_t input[] = { 2, 10 };
...
static void test_first_base_is_one(void)
{
   int8_t input[] = { 0 };
   int8_t expected[] = { 0 };
...
static void test_first_base_is_zero(void)
{
   int8_t input[] = { 0 };
   int8_t expected[] = { 0 };
...
static void test_first_base_is_negative(void)
{
   int8_t input[] = { 1 };
   int8_t expected[] = { 0 };
   test_rebase(-2, input, LENGTH(input), 10, expected, 0);
...
static void test_second_base_is_one(void)
{
   int8_t input[] = { 1, 0, 1, 0, 1, 0 };
   int8_t expected[] = { 0 };
...
static void test_second_base_is_zero(void)
{
   int8_t input[] = { 7 };
   int8_t expected[] = { 0 };
...
static void test_second_base_is_negative(void)
{
   int8_t input[] = { 1 };
   int8_t expected[] = { 0 };
