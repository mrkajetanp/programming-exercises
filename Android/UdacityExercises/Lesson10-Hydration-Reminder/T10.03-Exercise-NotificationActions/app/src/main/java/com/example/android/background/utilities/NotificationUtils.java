...
public class NotificationUtils {
    ...
    private static final int ACTION_DRINK_PENDING_INTENT = 1;
    private static final int ACTION_IGNORE_PENDING_INTENT = 14;
    ...
    private static Action ignoreReminderAction(Context context) {
        ...
        PendingIntent ignoreReminderPendingIntent = PendingIntent.getService(
                context, ACTION_IGNORE_PENDING_INTENT, ignoreReminderIntent,
    ...
    private static Action drinkWaterAction(Context context) {
        ...
        PendingIntent incrementWaterPendingIntent = PendingIntent.getService(
                context, ACTION_DRINK_PENDING_INTENT, incrementWaterCountIntent,
