...
public class DetailActivity extends AppCompatActivity implements
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        String descriptionAlly = "Forecast: {description}";
        ...
        String highAlly = "High: {highString}";
        ...
        String humidityAlly = "Humidity: {humidityString}";
        ...
        String windAlly = "Wind speed and direction: {windString}";
        ...
        String pressureAlly = "Pressure: {pressureString}";
